...
--SELECT CLASS_NAME, PROFESSOR_NAME
--FROM TB_CLASS 
--JOIN TB_DEPARTMENT USING(TB_DEPARTMENT)
--WHERE CATEGORY = '인문사회';
...
WHERE CATEGORY = '인문사회';
-- ORA-009018 : column ambiguous defined 컬럼의 정의가 애매모호하다.
--> 중복되ㄴ는 컬럼명을 구분할 수 있도록
-- > 테이블명.컬럼명 또는 별칭. 컬럼명으로 구분

-- 10. ??> 됨, 나도 품
SELECT STUDENT_NO 학번, STUDENT_NAME 학생이름, AVG(POINT)
FROM TB_STUDENT S
...
ORDER BY SUBSTR(STUDENT_SSN,1,4) ;
